    ...
    <div className="wrap">
      <div className="page-head">
        <div>
          <h1>Today — {today}</h1>
          <p>
            Next meeting first, then this week’s replies. Nothing sends from here.
          </p>
        </div>
      ...
      {book.configured && book.firms > 0 ? (
        <p className="faint" style={{ marginBottom: 12 }}>
          {book.firms.toLocaleString("en-GB")} firms · {book.people.toLocaleString("en-GB")} people
          {book.pendingReview > 0 ? ` · ${book.pendingReview} still in review` : ""}
