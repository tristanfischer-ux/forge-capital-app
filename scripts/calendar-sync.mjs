...
// Mirrors gmail-sync.mjs — read .env.local into process.env so launchd
// (which runs with `env -i`, no inherited shell vars) can reach Supabase
// and Google OAuth without the plist having to carry secrets.
